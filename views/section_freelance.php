<!-- BLOG -->
<section class="blog" id="freelance">
	<div class="container">
		<!-- Section Header -->
		<div class="section-header">
			<h2 class="section-title">Freelance Work</h2>
			<h3 class="section-subtitle">A sampling of some freelance work I&apos;ve done</h3>
		</div>
		<!-- End Section Header -->

		<!-- Section Content -->
		<div class="r1 row animateblock btt speed-1">
			<div class="c1 col-md-12" id="blog-carousel-2">
				...
				<div class="wrapper-post">
					...
					<div class="thumb-overlay">
						<a class="link-thumb" href="#">
							<img class="img-responsive thumb" src="images/work/freelance/SegoLilyCAD.flyers.png" alt="Sego Lily Center for Abused Deaf" />
						</a>
						<time class="published">2016</time>
					</div>
					<!-- Post content -->
					<div class="content">
						...
						<div class="footer-post">
							<a class="comments" href="#"><i class="fa fa-paint-brush"></i>&nbsp;Adobe Photoshop, Adobe Illustrator</a>
							<a class="read-more" href="#" title="Read More"><span class="fa fa-plus"></span></a>
						</div>
					</div>
				</div>
				<div class="wrapper-post">
					...
					<div class="content">
						...
						<div class="footer-post">
							<a class="comments" href="#"><i class="fa fa-code"></i>&nbsp;HTML, CSS, JavaScript</a>
							<a class="read-more" href="#" title="Read More"><span class="fa fa-plus"></span></a>
						</div>
					</div>
				</div>
				<div class="wrapper-post">
					...
					<div class="content">
						...
						<div class="footer-post">
							<a class="comments" href="#"><i class="fa fa-paint-brush"></i>&nbsp;Photoshop, Illustrator<!--, Wacom Tablet--></a>
							<a class="read-more" href="#" title="Read More"><span class="fa fa-plus"></span></a>
						</div>
					</div>
				</div>
				...
				<div class="wrapper-post">
					...
					<div class="content">
						...
						<div class="footer-post">
							<a class="comments" href="#"><span class="fa fa-code"></span>&nbsp;HTML, CSS, PHP, Flash, Photoshop<!--, Wacom Tablet--></a>
							<a class="read-more" href="#" title="Read More"><span class="fa fa-plus"></span></a>
						</div>
					</div>
				</div>
