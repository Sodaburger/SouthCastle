	...
	<div class="c1 col-xs-12 col-sm-8 main">
		...
		<section class="blog-content">
			...
			<div class="container-fluid">
				...
				<!-- Categories -->
				<div class="r1 row module module-categories">
					<!-- Module Header -->
					<div class="module-header">
						<h2 class="module-title">R&eacute;sum&eacute;</h2>
					</div>
					<!-- Nav tabs -->
					<ul class="nav nav-tabs list-grid" role="tablist">
							...
							<div class="c3 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										...
										<li>Established file hierarchy and web standards for Community and HCM sites</li>
							...
							<div class="c4 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										...
										<li>Updated and added content and product pages to ZAGG.com utilizing in-house system on CodeIgniter framework</li>
										<li>Combined ZAGG and iFrogz websites into adaptive design utilizing CodeIgniter and Bootstrap frameworks</li>
										<li>Led a team of programmers for implementing site redesign utilizing Bootstrap, SASS, and responsive designs</li>
										<li>Implemented site redesign  onto Magento Platform</li>
										<li>Worked closely with designers and developers to create various email and web page templates, which increased efficiency in both design and development</li>
									</ul>
								</div>
							</div>
							...
							<div class="c5 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										...
										<li>Implemented content changes utilizing HTML &amp; other (such as CSS) when needed</li>
										<li>Revised a variety of documents and procedures for Consumer Travel Network</li>
									</ul>
								</div>
							</div>
							...
							<div class="c6 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										...
										<li>Assembled customer orders</li>
									</ul>
								</div>
							</div>
							...
							<div class="c7 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										...
										<li>Did graphic design and copy jobs per customer requests</li>
									</ul>
								</div>
							</div>
							...
							<div class="c8 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										...
										<li>Managed MySpace pages for Las Vegas Sands Corp. properties</li>
									</ul>
								</div>
							</div>
							...
							<div class="c9 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										...
										<li>Created advertising, flyers, posters for student events, utilizing Photoshop, Illustrator</li>
									</ul>
								</div>
							</div>

						</div>
				<!-- End Tab panes: Employment -->

				<!-- Tab panes: Freelance -->
						<div role="tabpanel" class="tab-pane fade" id="Freelance">
							...
							<div class="c5 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										...
										<li>Created marketing and promotional items, including signs, flyers, email blasts (utilizing MailChimp)</li>
										<li>Designed company website utilizing PHP, JavaScript</li>
									</ul>
								</div>
							</div>
				...
				<!-- End Tab panes: Freelance -->
<?php /*
				<!-- Tab panes: Experience -->
						<div role="tabpanel" class="tab-pane fade" id="Experience">
							...
							<div class="c1 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										<li>Created Marketing and Promotional Items, including Folders, Duratrans</li>
									</ul>
								</div>
							</div>
							...
							<div class="c2 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<strong class="job-title">Graphic Design</strong>
									<ul class="description">
										<li>Created Marketing and Promotional Items, including Menu, Flyers, Email Blasts</li>
									</ul>
								</div>
							</div>
							...
							<div class="c4 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<strong class="job-title">Web Design</strong>
									<ul class="description">
										<li>Integrated new logo design into web site</li>
										<li>Setup beta site and database using WordPress</li>
									</ul>
								</div>
							</div>
							...
							<div class="c5 col-xs-12 media wrapper-post">
								...
								<div class="media-body content">
									...
									<ul class="description">
										<li>Manage and update ward photo directory, utilizing Photoshop</li>
										<li>Update events and activities on website calendar</li>
									</ul>
								</div>
							</div>

						</div>
				<!-- End Tab panes: Experience -->
*/ ?>
					</div>
				...
				<!-- Pagination -->
				<div class="r2 row wrapper-pagination">
<?php /*
	...
	<aside class="c2 col-xs-12 col-sm-4 sidebar">
		...
		<section class="module module-objective">
			<div class="container-fluid wrapper-module">
				<!-- Section Header -->
				<div class="module-header">
					<h2 class="module-title">Profile</h2>
				</div>
				<!-- End Section Header -->
				<!-- Section Content -->
		...
		<section class="module module-Education">
			<div class="container-fluid wrapper-module">
				<!-- Section Header -->
				<div class="module-header">
					<h2 class="module-title">Education</h2>
				</div>
				<!-- End Section Header -->
				<!-- Section Content -->
				<div class="r1 row wrapper-module-content">
